...
let { types } = require("../utils");

function executeOrganize(dirName) {
    let orgFilePath = createOrganizedDirectories(dirName);
    organizeDirectory(dirName, orgFilePath);
    console.log("Files organized successfully!")
};

function createOrganizedDirectories(dirPath) {
    let orgFilePath = path.join(dirPath, "organized_files");
    // organized files directory
