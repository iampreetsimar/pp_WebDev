...
// // CUSTOM PROMISE TO SET AUTOCOMPLETE SETTINGS TO DISABLE IN CODE EDITOT
// function autoCompleteSettingsHanlder() {
//     return new Promise(function(resolve, reject) {

//         // wait for settings selector and click
//         let settingsClickedPromise = waitAndClick("button[aria-label='Editor Settings']");
//         settingsClickedPromise
//             .then(function() {
//                 // wait to disable button and click
//                 let autoCompleteDisablePromise = waitAndClick("button[aria-label='Disable Autocomplete']");
//                 return autoCompleteDisablePromise;
//             }).then(function() {
//                 // click inside editor/settings selector
//                 let settingsHidePromise = click("button[aria-label='Editor Settings']");
//                 return settingsHidePromise;
//             }).then(function() {
//                 resolve();
//             }).catch(function() {
//                 reject();
